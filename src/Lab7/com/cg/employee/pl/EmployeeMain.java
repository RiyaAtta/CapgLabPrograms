package Lab7.com.cg.employee.pl;

import java.util.Scanner;

import Lab7.com.cg.employee.service.EmployeeService;
/**
 * Main class for employee insurance by RIYA
 * @author RIYA
 *
 */
public class EmployeeMain {
	...
	public static void main(String[] args) {
		...
		while(ch=='y') {
			...
			/**
			 * switch method implemented by Riya Atta
			 */
			switch(choice) {
			case 1:
